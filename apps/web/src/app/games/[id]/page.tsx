"use client";
import GameGoal from "@/app/games/[id]/components/GameGoal";
...
import { GameReferees } from "./components/GameReferees";
          ...
          <CardContent>
            <div className="flex flex-row gap-8 justify-center p-4">
              <div className="flex flex-row gap-2">
                ...
                {isCompleted && (
                  <div
                    className={clsx("text-2xl", { "font-bold": awayTeamWin })}
                  >
              ...
              <div className="flex flex-row gap-2">
                ...
                {isCompleted && (
                  <div
                    className={clsx("text-2xl", { "font-bold": homeTeamWin })}
                  >
